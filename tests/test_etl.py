...
def test_update_measure_no_initial_data(mock_raw_query, mock_raw_query_data):
...
@freeze_time('2017-07-01 13:00')
def test_update_measure_with_initial_data(mock_raw_query, mock_raw_query_data,
                                          base_datapoint_time):
    from missioncontrol.etl.measure import update_measure
    existing_data = {
        '20170629075044': {
